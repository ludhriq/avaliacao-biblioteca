...
const currentPublisherInfo = jsonData.data.publishers.find(i => i.id == id);
...
name.value = currentPublisherInfo.name;
...
const onSubmit = handleSubmit((values) => {
    ...
    const publisherIndex = jsonData.data.publishers.findIndex(i => i.id == id);
    jsonData.data.publishers[publisherIndex] = publisherObject;
